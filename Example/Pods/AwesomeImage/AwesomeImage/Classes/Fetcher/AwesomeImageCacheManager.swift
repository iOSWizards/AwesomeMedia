//
//  AwesomeImageCacheManager.swift
//  AwesomeImage
//
...
public class AwesomeImageCacheManager: NSObject {
    ...
    public func cacheObject(_ object: Any, forKey: String) {
        nsCache.setObject(object as AnyObject, forKey: NSString(string: forKey))
    }
    
    public func objectForKey(_ forKey: String) -> AnyObject? {
