...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AwesomeCore/AwesomeCore.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AwesomeLocalization/AwesomeLocalization.framework"
