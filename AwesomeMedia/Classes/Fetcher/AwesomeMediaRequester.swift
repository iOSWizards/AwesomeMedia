    ...
    open func performRequest(
        ...
        if forceUpdate == false && shouldCache {
            if self.cacheManager == nil {
                if let data = AwesomeMediaCacheManager.getCachedObject(urlRequest as URLRequest) {
            ...
            if let error = error {
                ...
                if let httpResponse = response as? HTTPURLResponse, httpResponse.statusCode == 401  {
                    ...
                    if shouldCache || forceUpdate {
                        if self.cacheManager == nil {
                            AwesomeMediaCacheManager.cacheObject(urlRequest as URLRequest, response: response, data: data)
...
extension AwesomeMediaRequester {
