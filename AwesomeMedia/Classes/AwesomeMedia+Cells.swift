...
extension AwesomeMedia {
    ...
    public static func registerVideoCell(to tableView: UITableView, withIdentifier identifier: String) {
        tableView.register(UINib(nibName: "AwesomeMediaVideoTableViewCell", bundle: Bundle(for: AwesomeMediaVideoTableViewCell.self)), forCellReuseIdentifier: identifier)
    }
